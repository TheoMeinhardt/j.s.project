<template>
  <div class="q-pa-xl">
    <p class="text-h2">Datenschutzerklärung</p>

    <div class="text-body1">
      <p class="text-h4">1. Datenschutz auf einen Blick</p>
      <p class="text-h5">Allgemeine Hinweise</p>
      <p>Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können. Ausführliche Informationen zum Thema Datenschutz entnehmen Sie unserer unter diesem Text aufgeführten Datenschutzerklärung.</p>
      <p class="text-h5">Datenerfassung auf dieser Website</p>
      ...
      <p class="text-h4">2. Hosting</p>
      <p class="text-h5">Externes Hosting</p>
      ...
      <p class="text-h4">3. Allgemeine Hinweise und Pflichtinformationen</p>
      <p class="text-h5">Datenschutz</p>
      ...
      <p class="text-h5">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</p>
      <p>
      ...
      <p class="text-h5">Auskunft, Löschung und Berichtigung</p>
      <p>Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung oder Löschung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden.</p>
      <p class="text-h5">Recht auf Einschränkung der Verarbeitung</p>
      ...
      <p class="text-h5">Widerspruch gegen Werbe-E-Mails</p>
      <p>Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten zur Übersendung von nicht ausdrücklich angeforderter Werbung und Informationsmaterialien wird hiermit widersprochen. Die Betreiber der Seiten behalten sich ausdrücklich rechtliche Schritte im Falle der unverlangten Zusendung von Werbeinformationen, etwa durch Spam-E-Mails, vor.</p>
      <p class="text-h4">4. Datenerfassung auf dieser Website</p>
      ...
      <p class="text-h5">Kontaktformular</p>
      ...
      <p class="text-h5">Anfrage per E-Mail, Telefon oder Telefax</p>
      ...
      <p class="text-h5">Verarbeiten von Daten (Kunden- und Vertragsdaten)</p>
      <p>
        Wir erheben, verarbeiten und nutzen personenbezogene Daten nur, soweit sie für die Begründung, inhaltliche Ausgestaltung oder Änderung des Rechtsverhältnisses erforderlich sind (Bestandsdaten). Dies erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO, der die Verarbeitung von Daten zur Erfüllung eines Vertrags oder vorvertraglicher Maßnahmen gestattet. Personenbezogene Daten über die Inanspruchnahme dieser Website (Nutzungsdaten) erheben, verarbeiten und nutzen wir nur, soweit dies
